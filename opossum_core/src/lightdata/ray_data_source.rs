...
impl From<ImageSrc> for RayDataSource {
    fn from(value: ImageSrc) -> Self {
        Self::Image(value)
    }
}

impl From<PointSrc> for RayDataSource {
    fn from(value: PointSrc) -> Self {
        Self::PointSrc(value)
    }
}

impl From<CollimatedSrc> for RayDataSource {
    fn from(value: CollimatedSrc) -> Self {
        Self::Collimated(value)
    }
}

impl From<Rays> for RayDataSource {
    fn from(value: Rays) -> Self {
        Self::Raw(value)
    }
}

impl DefaultFromName for RayDataSource {}
...
impl Default for RayDataSource {
    fn default() -> Self {
...
impl std::fmt::Debug for RayDataSource {
...
impl Display for RayDataSource {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Raw(r) => write!(f, "Raw({r})"),
            Self::Collimated(_) => {
