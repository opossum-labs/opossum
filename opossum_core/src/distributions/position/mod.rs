...
//!
//! ```rust
//! use opossum_core::{millimeter, distributions::position::{PositionDistribution, Random}};
//!
//! let grid=Random::new(
//!   millimeter!(1.0),
//!   millimeter!(2.0),
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Copy, EnumIter, EnsureValidated)]
