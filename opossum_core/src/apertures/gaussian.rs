...
mod test {
    ...
    fn getters() -> OpmResult<()> {
        let g = GaussianShape::new((meter!(1.0), meter!(2.0)), meter!(3.0, 4.0))?;
    ...
    fn transmission_factor() -> OpmResult<()> {
        let g = GaussianShape::new((meter!(1.0), meter!(1.0)), meter!(1.0, 1.0))?;
    ...
    fn test_sigma_decay() -> OpmResult<()> {
        ...
        let g = GaussianShape::new((sigma_x, sigma_y), meter!(0.0, 0.0))?;
