...
mod test {
    ...
    #[test]
    fn from_csv_ok() {
        let s = Spectrum::from_csv("files_for_testing/spec_to_csv_test_01.csv");
        assert!(s.is_ok());
    ...
    fn from_csv_err() {
        ...
        assert!(Spectrum::from_csv("files_for_testing/spec_to_csv_test_02.csv").is_err());
        assert!(Spectrum::from_csv("files_for_testing/spec_to_csv_test_03.csv").is_err());
        assert!(Spectrum::from_csv("files_for_testing/spec_to_csv_test_04.csv").is_err());
    }
    #[test]
    fn range() {
        let s = prep();
