import { addNode, connectNodes, getNodeInfo, setInverted, setLidt, setName } from './snippets/yew-gui-30ae8fb80d13f1cf/invoke.js';
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_addNode_36264ebb91325626 = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            const ret = addNode(getStringFromWasm0(arg0, arg1));
            return ret;
        } finally {
    ...
    imports.wbg.__wbg_connectNodes_47351bdcafc7e92a = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8) {
        let deferred0_0;
        let deferred0_1;
        let deferred1_0;
        let deferred1_1;
        ...
        try {
            ...
            deferred3_0 = arg6;
            deferred3_1 = arg7;
            const ret = connectNodes(getStringFromWasm0(arg0, arg1), getStringFromWasm0(arg2, arg3), getStringFromWasm0(arg4, arg5), getStringFromWasm0(arg6, arg7), arg8);
            return ret;
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
    ...
    imports.wbg.__wbg_getNodeInfo_fcadd4f27c0683ba = function(arg0, arg1) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            const ret = getNodeInfo(getStringFromWasm0(arg0, arg1));
            return ret;
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    ...
    imports.wbg.__wbg_setInverted_677921837691fa5f = function(arg0, arg1, arg2) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            const ret = setInverted(getStringFromWasm0(arg0, arg1), arg2 !== 0);
            return ret;
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    imports.wbg.__wbg_setLidt_dc6691eb7d32ca3c = function(arg0, arg1, arg2) {
        let deferred0_0;
        let deferred0_1;
        try {
            deferred0_0 = arg0;
            deferred0_1 = arg1;
            const ret = setLidt(getStringFromWasm0(arg0, arg1), arg2);
            return ret;
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
        }
    };
    imports.wbg.__wbg_setName_749fccb3ee62882b = function(arg0, arg1, arg2, arg3) {
        let deferred0_0;
        let deferred0_1;
        let deferred1_0;
        let deferred1_1;
        try {
            ...
            deferred1_0 = arg2;
            deferred1_1 = arg3;
            const ret = setName(getStringFromWasm0(arg0, arg1), getStringFromWasm0(arg2, arg3));
            return ret;
        } finally {
            wasm.__wbindgen_free(deferred0_0, deferred0_1, 1);
            wasm.__wbindgen_free(deferred1_0, deferred1_1, 1);
    ...
    imports.wbg.__wbindgen_closure_wrapper2457 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 299, __wbg_adapter_24);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('yew-gui_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
