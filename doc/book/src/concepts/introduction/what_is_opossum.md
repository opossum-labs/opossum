...
As of now, OPOSSUM’s core capabilities reside in ray-tracing optical setups. In upcoming versions, these capabilities will be further extended, as weill be detailed in the [Upcoming](./upcoming.md) section.  
