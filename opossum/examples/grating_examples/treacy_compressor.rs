...
pub fn treacy_compressor(alignment_wvl: Length) -> OpmResult<NodeGroup> {
    ...
    cb.connect_nodes(i_g1, "diffracted", i_g2, "input", millimeter!(100.0))?;
    cb.connect_nodes(i_g2, "diffracted", i_g3, "input", millimeter!(250.0))?;
    cb.connect_nodes(i_g3, "diffracted", i_g4, "input", millimeter!(100.0))?;
