...
mod test {
    ...
    fn all_nodes_integration_test() {
        let mut scenery = NodeGroup::default();
        let src = round_collimated_ray_source(millimeter!(10.0), joule!(1.0), 2).unwrap();
        ...
        // let i_9 = scenery.add_node(&ParaxialSurface::default()).unwrap();
        // let i_10 = scenery
        ...
        // let i_15 = scenery.add_node(&ReflectiveGrating::default()).unwrap();
        // let i_16 = scenery.add_node(&ThinMirror::default()).unwrap();

        scenery
            .connect_nodes(i_0, "output_1", i_2, "input_1", millimeter!(5.0))
            .unwrap();
        // scenery
        ...
        //     .unwrap();
        // scenery
        //     .connect_nodes(i_14, "output_1", i_15, "input_1", millimeter!(5.0))
        //     .unwrap();
        // scenery
        //     .connect_nodes(i_15, "output_1", i_16, "input_1", millimeter!(5.0))
        //     .unwrap();
        ...
        doc.save_to_file(Path::new("../opossum/playground/all_nodes_integration_test.opm")).unwrap();
    }
}
